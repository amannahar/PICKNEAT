        ...
        <div className="card mt-3" style={{ width: "16rem", maxHeight: "360px" }}>
            ...
            <div className="card-body">
                ...
                <div className='container w-100'>
                    <select className='m-2 h-100' defaultValue="1" onChange={(e) => setQty(e.target.value)}>
                    ...
                    <select className='m-2 h-100 rounded' defaultValue={priceOption[0]} ref={priceRef} onChange={(e) => setSize(e.target.value)}>
